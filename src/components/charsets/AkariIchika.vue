<template>
    <div class="w-full h-full relative">
        ...
        <div :style="`background-color: ${charData.palettes[3]}`" class="absolute opacity-75 left-14 top-16 h-32 w-1"></div>
        ...
        <div :style="`background-image: url(${charData.char}); 
            ...
            class="absolute h-full z-20
                    left-6 sm:left-4 md:left-0 lg:-left-8
                    top-16 sm:top-16 md:top-16 lg:top-12
                    w-72 sm:w-96"></div>
        <h2 class="absolute serif uppercase text-gray-700 leading-tight tracking-name z-10
                    text-2xl sm:text-5xl
                    w-auto
                    text-right sm:text-left
                    top-3 sm:top-8 md:top-6 lg:top-6
                    left-40 sm:left-56 md:left-32 lg:left-56
        ...
        <h4 class=" absolute serif uppercase text-gray-700 break-words tracking-tagline z-10
                    ...
                    ml-8 md:ml-0
                    sm:top-24 md:top-20
                    sm:left-64 md:left-72 lg:left-110
                    sm:right-6 md:right-32
                    hidden sm:block">
            {{ charData.name.split(' ')[1] }}
        </h4>
        ...
        <div class="absolute z-10 serif uppercase text-gray-700 tracking-tagline text-right
            ...
            <div :style="`background-color: ${charData.palettes[3]}`" class="absolute hidden lg:block -left-4 -top-6 w-1 h-26 opacity-50 bg-gray-100"></div>
