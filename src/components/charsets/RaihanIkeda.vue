<template>
    <div class="w-full h-full relative">
        ...
        <div class="absolute z-10 serif uppercase text-gray-700 tracking-tagline text-right
            ...
            <div class="relative hidden lg:block text-xs text-left mt-4">
                <p class="mb-1">{{ charData.birthDate }}</p>
            </div>
        </div>
        ...
        <div class="absolute tracking-widest transform -rotate-60
                    ...
                    -mr-8 sm:mr-0
                    -mb-0 sm:mb-0
                    -right-80 sm:-right-64 md:-right-32 lg:right-20
                    bottom-64 sm:bottom-64 md:bottom-64 lg:bottom-64">
            <h5 class="serif text-xl">
                {{ charData.motto }}
            </h5>
            <h1 class="serif mt-2 text-8xl sm:text-5xl uppercase text-white tracking-tagline">
                <span class="hidden sm:block">{{ charData.tagline }}</span>
                <span class="block sm:hidden">{{ charData.tagline.split(' ')[0] }}</span>
            </h1>
        </div>
    </div>
</template>
