<template>
    <div class="flex flex-col items-center fixed z-50 bottom-4 right-4">
        ...
        <button v-if="isOpen" class="flex justify-center items-center w-12 h-12 bg-gray-600 text-white focus:outline-none rounded-full shadow-2xl mb-4">
            <svg class="w-4 h-4 text-white fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 512">
                <!-- Font Awesome Free 5.15.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) -->
                <path d="M20 424.229h20V279.771H20c-11.046 0-20-8.954-20-20V212c0-11.046 8.954-20 20-20h112c11.046 0 20 8.954 20 20v212.229h20c11.046 0 20 8.954 20 20V492c0 11.046-8.954 20-20 20H20c-11.046 0-20-8.954-20-20v-47.771c0-11.046 8.954-20 20-20zM96 0C56.235 0 24 32.235 24 72s32.235 72 72 72 72-32.235 72-72S135.764 0 96 0z"/>
            </svg>
        </button>
        <button v-if="isOpen" class="flex justify-center items-center w-12 h-12 bg-gray-600 text-white focus:outline-none rounded-full shadow-2xl mb-4">
            <svg class="w-4 h-4 text-white fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                <!-- Font Awesome Free 5.15.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) -->
        ...
        <button v-if="isOpen" class="flex justify-center items-center w-12 h-12 bg-gray-600 text-white focus:outline-none rounded-full shadow-2xl mb-4">
            <svg class="w-4 h-4 text-white fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                <!-- Font Awesome Free 5.15.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) -->
        ...
        <button v-if="isOpen" @click="open()" class="flex justify-center items-center w-14 h-14 bg-gray-600 text-white focus:outline-none rounded-full shadow-2xl">
            <svg class="w-4 h-4 text-white fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 352 512">
                <!-- Font Awesome Free 5.15.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) -->
